...
const Header = () => {
  return (
    <section className="gradient-bg rounded-3xl p-6 md:p-12 mb-12 relative overflow-hidden hero-mobile">
      <div className="absolute top-0 right-0 w-full h-full cute-dots"></div>
      <div className="relative z-10 flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 mb-8 md:mb-0">
          <h2 className="text-3xl md:text-5xl font-bold mb-4 hero-title">
            Découvrez la <span className="text-slate-900">Beauté Naturelle</span> avec Soft beauty! 🌸
          </h2>
          <p className="text-lg md:text-xl mb-6 text-gray-700 hero-subtitle">
          ...
          <div className="flex flex-col sm:flex-row gap-3 hero-cta-stack">
            <a href="#products" className="pink-btn px-6 py-4 text-lg wobble inline-flex items-center justify-center smooth" data-haptic>
              <Sparkles className="w-4 h-4 mr-2" /> Explorer les Produits
            </a>
            <a href="#contact" className="bg-white text-slate-900 border-2 border-slate-300 px-6 py-4 rounded-full text-lg hover:bg-gray-100 transition-all inline-flex items-center justify-center smooth" data-haptic>
